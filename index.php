...
use <#= ProjectNamespace #>\{UserProfile, Language, AdvancedSecurity, Timer, HttpErrorHandler};
...
require_once "../vendor/autoload.php";
<# } #>
require_once "<#= GetFileName("constants") #>";
require_once "<#= GetFileName("config") #>";
require_once "<#= GetFileName("phpfn") #>";
require_once "<#= GetFileName("userfn") #>";
...
// Add definitions
$containerBuilder->addDefinitions("<#= GetFileName("definitions") #>");
...
(require_once "<#= GetFileName("routes") #>")($app);
...
// Register routes (Add permission middleware)
(require_once "<#= GetFileName("apiroutes") #>")($app);
