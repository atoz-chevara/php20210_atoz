...
class LdapConn
{
    ...
    public $Dn = "<#= PROJ.LDAPDN #>"; // Default Distinguished Name, e.g. uid={username},ou=users,dc=demo,dc=com, "{username}" will be replaced by inputted user name
    public $Host = "<#= PROJ.LDAPHostName #>";
    public $Port = <#= PROJ.LDAPPortNumber || "389" #>;
    ...
    <#= GetServerScript("Global", "Ldap_Validated") #>
}
